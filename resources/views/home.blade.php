                ...
                <div class="col-lg-6">
                    ...
                    <div class="cardbox ">
                        <div class="cardbox-heading">
                            ...
                            <div class="dropdown pull-right">
                                ...
                                <div class="dropdown-menu dropdown-scale dropdown-menu-right" role="menu"
                                    ...
                                    <a class="dropdown-item" href="{{route('upload.edit', $posts->id)}}">Edit post</a>
                                    <a id="submit" class="dropdown-item" href="#">Delete post</a>
                                    @endif
                            ...
                            <!--/ dropdown -->
                            <!-- END dropdown-->
                            <form id="deletePost" action="{{route('post.delete', $posts->id)}}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <div class="media m-0">
                                ...
                                <div class="d-flex mr-3">
                                    <a href="#"><img class="img-responsive img-circle"
                                            src="storage/{{$posts->user['foto_profil']}}" alt="User"></a>
                                </div>
                        ...
                        <div class="cardbox-item">
                            <a href="#myModal{{$posts->id}}" data-toggle="modal">
                        ...
                        <div class="cardbox-like">
                            <ul>
                                ...
                                <li><a href="#" title="" class="com"><i class="fa fa-comments"></i></a> <span
                                        class="span-last"> 126,400</span></li>
                            </ul>
                        </div>
                        <!--/ cardbox-like -->
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 modal-image">
                                                <img class="img-responsive" style="width: 100%; height: auto;" src="storage/{{$posts->foto}}"
                                                    alt="Image" />
                                            </div>
                                            <!--/ col-md-8 -->
                                                ...
                                                <div class="modal-meta-top">
                                                    ...
                                                    <div class="img-poster clearfix">
                                                        <a href="#"><img class="img-responsive img-circle" src="assets/img/users/18.jpg"
                                                                alt="Image" /></a>
                                                        <strong><a href="#">{{$posts->user['name']}}</a></strong>
                                                        <span>{{$posts->created_at->diffForHumans()}}</span><br />
                        
                                                        <a href="#" class="kafe kafe-btn-mint-small" style="@if (Auth::user()->id == $posts->id_user)
                                          display: none;
                                        @endif"><i class="fa fa-check-square"></i> Following</a>
                                                    </div>
                                                    <!--/ img-poster -->
                                                    ...
                                                    <ul class="img-comment-list">
                                                        <li>
                                                            ...
                                                            <div class="comment-text">
                                                                <strong><a href="#">Orang Komen</a></strong>
                                                            ...
                                                            <li>
                                                                <span class="thumb-xs">
                                                                    <img class="img-responsive img-circle"
                                                                        src="../../../www.bootdey.com/img/Content/user_3.jpg" alt="Image">
                                                                </span>
...
<script type="text/javascript">
    ...
    $(function() {
        $('.infinite-scroll').jscroll({
            autoTrigger: true,
            loadingHtml: '<img class="center-block" src="/storage/preload.gif" alt="Loading..." />',
            padding: 10,
...
<script>
    ...
    function onSubmit() {
        if(!confirm("Ingin menghapus post?")) {
            return false;
    }
    document.getElementById("deletePost").submit();
}
