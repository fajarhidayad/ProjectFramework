      ...
      <nav class="navbar navbar-default">
       <div class="container-fluid">
	    <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="index-2.html"><i class="fab fa-instagram"></i> Fluffs</a>
		</div><!-- /.navbar-header -->
		 ...
		 <li class="dropdown mega-avatar">
		  ...
		  <div class="dropdown-menu w dropdown-menu-scale pull-right">
           ...
           <form id="logout" action="{{route('logout')}}" method="POST">
            @csrf
            <a class="dropdown-item" href="javascript:void()" onclick="document.getElementById('logout').submit();">Sign Out</a>
          </form>
		  </div>
		 </li><!-- /navbar-item -->	
